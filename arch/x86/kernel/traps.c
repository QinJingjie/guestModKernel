...
//DO_ERROR(x86_TRAP_VE,	  SIGBUS,  "virtualization_exception",	virtualization_exception)
...
{
	printk(KERN_ERR "kvm: #do_int3 called!\n");
...
//	set_system_intr_gate_ist(x86_TRAP_VE, &virtualization_exception, DEBUG_STACK);
